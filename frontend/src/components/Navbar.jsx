...
const Navbar = () => {
  ...
  return (
    <>
      {/* <Header /> */}
      <nav className="bg-gray-800 px-6 py-2 md:px-10 sticky top-0 z-50 w-full transition-all duration-300 border-b ">
        <div className="flex justify-between items-center">
          <Link to="/" className="flex items-center bg-white rounded-full">
            <img
              ...
              alt="Logo"
              className=" w-8 h-8 sm:w-14 sm:h-14 object-cover rounded-full   "
            />
          </Link>
          ...
          <FaLocationArrow className="text-white "/>
           <p className="text-white text-base">Hyderabad : 500008</p></div>
             ...
             <div className=" relative mx-4    w-[40vw] my-3 ">
  ...
  <Link
    to="/cart"
    className="relative flex items-center justify-center hidden md:block  text-black hover:text-indigo-600"
  >
